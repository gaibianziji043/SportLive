...
//        init();
    ...
    private void startDownloadApk() {
        ...
        DownloadMangerV2.download(downloadUrl, builder.getDownloadAPKPath(), getString(R.string.versionchecklib_download_apkname, builder.getApkName() != null ? builder.getApkName() : getPackageName()), new DownloadListener() {
            ...
            public void onCheckerDownloadSuccess(File file) {
                ...
                if (null != DownloadingActivity.downloadingActivity) {
                    DownloadingActivity.downloadingActivity.finish();
                }
                if (null != DownloadFailedActivity.activity) {
            ...
            public void onCheckerStartDownload() {
                ...
                if (!builder.isSilentDownload() && null != notificationHelper) {
    ...
    public void receiveEvent(CommonEvent commonEvent) {
        switch (commonEvent.getEventType()) {
            ...
            case AllenEventType.DOWNLOAD_RETRY:
                startDownloadApk();
                break;
