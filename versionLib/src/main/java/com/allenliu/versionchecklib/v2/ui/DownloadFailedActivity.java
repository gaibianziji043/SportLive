...
public class DownloadFailedActivity extends AllenBaseActivity implements DialogInterface.OnCancelListener {
    public static Dialog downloadFailedDialog;

    public static DownloadFailedActivity activity;
...
//        finish();
    ...
    ConnectionChangeReceiver mBroadcastReceiver;
    @Override
