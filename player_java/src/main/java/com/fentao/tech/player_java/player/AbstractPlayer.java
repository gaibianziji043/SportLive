 ...
 * @ClassName: AbstractPlayer
 * @Description: 抽象的播放器  继承此接口扩展自己的播放器
 * @Author: allen
 * @CreateDate: 2021/2/5 19:27
 * @UpdateUser: 更新者
 * @UpdateDate: 2021/2/5 19:27
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
public abstract class AbstractPlayer {
    ...
    /**
     * 绑定videoView
     * @param mPlayerEventListener
     */
    public void setmPlayerEventListener(PlayerEventListener mPlayerEventListener) {
