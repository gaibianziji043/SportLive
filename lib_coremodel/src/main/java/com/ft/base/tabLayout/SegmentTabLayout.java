...
import com.ft.base.utils.FragmentChangeManager;
...
public class SegmentTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private int mIndicatorDrawable1;
    private Drawable mIndicatorDrawableCustom;
    private int mIndicatorStartColor = -1;
    private int mIndicatorEndColor = -1;
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIndicatorStartColor = ta.getColor(R.styleable.SegmentTabLayout_tl_indicator_start_color, -1);
        mIndicatorEndColor = ta.getColor(R.styleable.SegmentTabLayout_tl_indicator_end_color, -1);
    ...
    public void setTabData(List<String> titlesList) {
        if (titlesList == null || titlesList.size() == 0) {
            throw new IllegalStateException("Titles can not be NULL or EMPTY !");
        }
        String[] strings = new String[titlesList.size()];
        for (int i = 0; i < titlesList.size(); i++) {
            strings[i] = titlesList.get(i);
        }
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mIndicatorStartColor != -1 && mIndicatorEndColor != -1) {
            Log.e("mCurrentTab--",mCurrentTab+"");
            Log.e("mLastTab--",mLastTab+"");

            if (mCurrentTab == 1) {
                int[] ints = new int[]{mIndicatorEndColor, mIndicatorStartColor};
                mIndicatorDrawable.setColors(ints);
            } else {
                int[] ints = new int[]{mIndicatorStartColor, mIndicatorEndColor};
                mIndicatorDrawable.setColors(ints);
            }
