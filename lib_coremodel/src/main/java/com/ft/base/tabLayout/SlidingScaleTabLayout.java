...
import com.ft.base.tabLayout.transformer.IViewPagerTransformer;
import com.ft.base.tabLayout.transformer.TabScaleTransformer;
import com.ft.sports.utils.ViewUtils;
import com.ft.sports.widget.UnreadMsgUtils;
...
public class SlidingScaleTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTextUnSelectSize = ta.getDimension(R.styleable.SlidingScaleTabLayout_tl_textUnSelectSize, sp2px(15));
        // 被选中的文字大小，默认额未选中的大小一样
        mTextSelectSize = ta.getDimension(R.styleable.SlidingScaleTabLayout_tl_textSelectSize, sp2px(19));
        ...
        mTabPadding = ta.getDimension(R.styleable.SlidingScaleTabLayout_tl_tab_padding, mTabSpaceEqual || mTabWidth > 0 ? dp2px(0) : dp2px(18));
        // 得到设置的上下间距和gravity
    ...
    private void addTab(final int position, String title, View tabView) {
       ...
       /* LinearLayout.LayoutParams lp_tab = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT);
        ...
        } else if (mTabCount > 1 && position == 0) {
            tabView.setPadding(sp2px(40),0,sp2px(57),0);
        } else {
            tabView.setPadding(0,0,sp2px(57),0);
        }
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
    ...
    private void updateTabStyles(int mCurrentTab) {
        for (int i = 0; i < mTabCount; i++) {
            View v = mTabsContainer.getChildAt(i);
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
            TextView tv_tab_title = (TextView) v.findViewById(R.id.tv_tab_title);
    ...
    public void setTextColor(int textSelectColor, int textUnselectColor, int mCurrentTab) {
        this.mTextSelectColor = textSelectColor;
        this.mTextUnSelectColor = textUnselectColor;
