...
public class ScreenUtil {
    ...
    public static int dp2px(float dpValue) {
        final float density = BaseApplication.getInstance().getResources().getDisplayMetrics().density;
        return (int) (dpValue * density + 0.5f);
    }
    ...
    public static int sp2px(float spValue) {
        final float scaledDensity = BaseApplication.getInstance().getResources().getDisplayMetrics().scaledDensity;
        return (int) (spValue * scaledDensity + 0.5f);
    }
