package com.ft.base.binding.viewadapter.view;
...
public class ViewAdapter {
     ...
     * isThrottleFirst 是否开启防止过快点击
     */
    @BindingAdapter(value = {"onClickCommandParams", "params", "isThrottleFirst"}, requireAll = false)
    public static void onClickCommandParams(final View view, final BindingCommand clickCommand, final Object params, final boolean isThrottleFirst) {
        if (isThrottleFirst) {
            RxView.clicks(view)
                    .subscribe(new Consumer<Object>() {
                        @Override
