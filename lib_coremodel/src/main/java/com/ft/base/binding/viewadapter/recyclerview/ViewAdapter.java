package com.ft.base.binding.viewadapter.recyclerview;
...
public class ViewAdapter {
    ...
    @BindingAdapter("SpaceItemDecorationCustom")
    public static void SpaceItemDecorationCustom(final RecyclerView recyclerView,RecyclerView.ItemDecoration itemDecoration){
        int screenWidth = ScreenUtils.getScreenWidth(); //屏幕宽度
        int itemWidth = SizeUtils.dp2px( 110); //每个item的宽度

        SpaceItemDecoration spaceItemDecoration = new SpaceItemDecoration((screenWidth - itemWidth * 3) / 6);
//        itemDecotation.set(spaceItemDecoration);
