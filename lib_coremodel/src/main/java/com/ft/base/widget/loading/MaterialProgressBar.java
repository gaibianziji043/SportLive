package com.ft.base.widget.loading;
...
public class MaterialProgressBar extends View {
    ...
    private void initAttribute(Context context, AttributeSet attrs, int defStyle) {
        ...
        arcColor = typedArray.getColor(R.styleable.MaterialProgressBar_progress_arcColor,getResources().getColor(R.color.colorBackground));
