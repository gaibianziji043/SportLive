...
public class NetWorkUtils {
     ...
     * 获取设备拨号运营商
     *
     * @return ["中国电信CTCC":"CT"]["中国联通CUCC:"CU"]["中国移动CMCC":"CM"]["other":"0"]["无sim卡":"-1"]
     */
    public static String getSubscriptionOperatorType(Context context) {
        ...
        if ("46001".equals(operator) || "46006".equals(operator) || "46009".equals(operator)) {
            opeType = "CU";
            // 中国移动
        } else if ("46000".equals(operator) || "46002".equals(operator) || "46004".equals(operator) || "46007".equals(operator) || "46008".equals(operator)) {
            opeType = "CM";
            // 中国电信
    ...
    /*private void getNetIp() {
        HttpSend.post(Shadowsocks.this)
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(String response, Headers headers) {
                        if (response.indexOf("{") > -1) {
                            String jsonStr = response.substring(response.indexOf("{"), response.indexOf(";"));
                            LogUtils.loge(jsonStr);
                            try {
                                JSONObject jsonObect = new JSONObject(jsonStr);
                                String cip = jsonObect.getString("cip"); // 外网ip
    ...
    public Handler h = new Handler(){
        ...
        public void handleMessage(Message msg) {
            if(msg.what == 1){
                LogUtils.loge("===外网IP==" + msg.obj.toString());
            }
        }
    };
}
